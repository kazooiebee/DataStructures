...
remove_matching_elements(z, sqrt( double(10*(2+1)) ));
cout << "Contents of vector z: ";
for ( Vec<double>::size_type j = 0; j < z.size(); j++ )
  cout << " " << z[j];
  ...
  v4[5] = 6;
  v4[8] = 5;
  std::cout<<std::endl <<std::endl<< "New v4" <<std::endl;
  v4.print();
  for ( i = 0; i<v4.size(); ++i )
     cout << " " << v4[i];
  std::cout<< std::endl<< "Removed 1's";
  std::cout << std::endl << "Returns: " << remove_matching_elements(v4, 1) <<std::endl;
  for ( i = 0; i<v4.size(); ++i )
     cout << " " << v4[i];
std::cout << std::endl;
  v4.print();
  std::cout<< std::endl<< "Removed 6's" <<std::endl;
  std::cout << "Returns: " <<   remove_matching_elements(v4, 6) <<std::endl;
  for ( i = 0; i<v4.size(); ++i )
     cout << " " << v4[i];
  std::cout << std::endl;
  v4.print();
  std::cout<< std::endl<< "Removed 5's" <<std::endl;
  std::cout << "Returns: " <<   remove_matching_elements(v4, 5) <<std::endl;
  for ( i = 0; i<v4.size(); ++i )
    cout << " " << v4[i];
  std::cout << std::endl;
  v4.print();
