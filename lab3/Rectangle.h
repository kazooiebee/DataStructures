...
public:
  ...
  bool is_point_within(const Point2D& p) const; //IM
...
std::vector<Point2D> points_in_both(const Rectangle& r1, const Rectangle& r2); //IM

// to aid with debugging, output all the private member data for this rectangle
void print_rectangle(const Rectangle& r1); //IM
